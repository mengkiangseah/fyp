...
\begin{acknowledgments}
	...
	\\\\
	Thomas Akinola receives special thanks for his expertise in LEDs, and Helen Root kindly lent her voice to the Goodbye and Welcome messages.
\end{acknowledgments}
...
\\\\
Overall, the setup showed its feasibility and functionality, while taking into account the limitations of an audience less familiar with technology for interfacing and setup. \todo{If needed}
\end{abstract}
